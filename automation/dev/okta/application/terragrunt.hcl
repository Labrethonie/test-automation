...
inputs = {
    ...
    client_id = "0oa5wplwokuwI83as0x7"
    consent_method = "REQUIRED"
    hide_ios = true
    hide_web = true
    issuer_mode = "DYNAMIC"
    response_types = ["code"]
    oauth_scopes = ["okta.logs.read", "okta.schemas.manage", "okta.eventHooks.manage", "okta.groups.read", "okta.users.read", "okta.apps.read", "okta.roles.read", "okta.apps.manage", "okta.groups.manage", "okta.users.manage"]
