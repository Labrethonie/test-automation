...
inputs = {
    ...
    client_id = "0oa5fkx560dTwAbp50x7"
    consent_method = "REQUIRED"
    hide_ios = true
    hide_web = true
    issuer_mode = "DYNAMIC"
    response_types = ["code"]
    oauth_scopes = ["okta.logs.read", "okta.eventHooks.manage", "okta.groups.read", "okta.users.read", "okta.apps.read", "okta.apps.manage", "okta.groups.manage", "okta.schemas.read", "okta.users.manage"]
